...
<div class="main">
<h1>Welcome to Online Quiz Exam  - Start Here</h1>
	<div class="segment" style="margin-right:30px;">
		<img src="img/online_exam.png"/>
	</div>
	<div class="segment">
	<h2>Online Exam</h2>
        <p style="text-align: justify; display: block; font-size: 16px; color: #444444">Online Quiz examination is conducting a test online to measure the knowledge of the participants on a given topic.
